...
public class DataArray
{
    ...
    {
        List<int> tmpList = CreateArraySorted((int)(arraySize * 0.5f));
        List<int> randomList = CreateArrayRandom(Mathf.CeilToInt(arraySize * 0.5f), (int)(arraySize * 0.5f));
    ...
    {
        List<int> tmpList = CreateArraySorted(Mathf.CeilToInt(arraySize * 0.5f), (int)(arraySize * 0.5f));
        List<int> randomList = CreateArrayRandom((int)(arraySize * 0.5f));
    ...
    {
        List<int> tmpList = CreateArraySorted((int)(arraySize * 0.5f));
        List<int> invertList = CreateArrayInverted(arraySize - 1, (int)(arraySize * 0.5f));
    ...
    {
        List<int> tmpList = CreateArrayMirrored(arraySize);
        tmpList.Reverse();
