...
public class VisualizerColoringComparer : VisualizationColoringBase
{
    public VisualizerColoringComparer(List<Image> elementsList) : base(elementsList)
    {
    }
    ...
    public override void MarkElements()
    {
        ...
        for (int i = 0; i < marksList.Count; i++)
        {
            ...
            if (i == 0)
                elementsList[marksList[i]].color = Color.green;
        }
